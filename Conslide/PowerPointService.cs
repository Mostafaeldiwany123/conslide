    ...
    public class PowerPointService
    {
        ...
        public string CreateSlideFromJson(string json)
        {
            ...
            try
            {
                ...
                try
                {
                    slide.Tags.Add("conslide_generated", "true");
                }
                catch { }
        ...
        public string GetCurrentSlideAsJson()
        {
            ...
            try
            {
                ...
                // Check if slide was generated by Conslide
                bool madeByConslide = false;
                try
                {
                    // Tags.Item returns empty string if tag doesn't exist
                    string tagValue = slide.Tags["conslide_generated"];
                    madeByConslide = !string.IsNullOrEmpty(tagValue) && tagValue.ToLower() == "true";
                }
                catch { madeByConslide = false; }

                var result = new Dictionary<string, object> { { "shapes", shapesList }, { "madebyconslide", madeByConslide } };
                var ser = new JavaScriptSerializer();
